...
import BookmarkToggleButton from "../../elements/button/providers/toggle/bookmark";
...
import type { BookmarkToggleButtonProps } from "../../elements/button/providers/toggle/bookmark";
