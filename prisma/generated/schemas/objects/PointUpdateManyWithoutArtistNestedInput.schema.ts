...
const Schema: z.ZodType<Prisma.PointUpdateManyWithoutArtistNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => PointUpsertWithWhereUniqueWithoutArtistInputObjectSchema),
        z
          .lazy(() => PointUpsertWithWhereUniqueWithoutArtistInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => PointUpdateWithWhereUniqueWithoutArtistInputObjectSchema),
        z
          .lazy(() => PointUpdateWithWhereUniqueWithoutArtistInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const PointUpdateManyWithoutArtistNestedInputObjectSchema = Schema;
