...
interface ArtistsUpdateFormProps<T> {
	data: T[]
	autocompleteProps: Omit<AutocompleteProps<T, false, false, false>, "renderInput"> & { textFieldProps: TextFieldProps }
	loadingButtonProps: Omit<LoadingButtonProps, "onClick"> & { onClick: (value: T | undefined) => void }
	onDestroy: (value: T) => void
}
function ArtistsUpdateForm({ data, autocompleteProps, loadingButtonProps, onDestroy }: ArtistsUpdateFormProps<Artist>) {
