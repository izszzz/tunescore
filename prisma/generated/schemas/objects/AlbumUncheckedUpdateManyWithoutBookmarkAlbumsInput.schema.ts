...
const Schema: z.ZodType<Prisma.AlbumUncheckedUpdateManyWithoutBookmarkAlbumsInput> =
  z
    .object({
      title: z
        .union([
...
export const AlbumUncheckedUpdateManyWithoutBookmarkAlbumsInputObjectSchema =
  Schema;
