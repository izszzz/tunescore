...
const Schema: z.ZodType<Prisma.ArtistUpdateManyWithoutMusicsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ArtistUpsertWithWhereUniqueWithoutMusicsInputObjectSchema),
        z
          .lazy(() => ArtistUpsertWithWhereUniqueWithoutMusicsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => ArtistUpdateWithWhereUniqueWithoutMusicsInputObjectSchema),
        z
          .lazy(() => ArtistUpdateWithWhereUniqueWithoutMusicsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
