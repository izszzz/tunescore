...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithoutBandNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => BookmarkUpsertWithWhereUniqueWithoutBandInputObjectSchema),
        z
          .lazy(() => BookmarkUpsertWithWhereUniqueWithoutBandInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => BookmarkUpdateWithWhereUniqueWithoutBandInputObjectSchema),
        z
          .lazy(() => BookmarkUpdateWithWhereUniqueWithoutBandInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const BookmarkUpdateManyWithoutBandNestedInputObjectSchema = Schema;
