...
const Schema: z.ZodType<Prisma.FollowCreateNestedManyWithoutFollowingInput> = z
  .object({
    create: z
      .union([
...
export const FollowCreateNestedManyWithoutFollowingInputObjectSchema = Schema;
