...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBookmarkBandsInput> = z
  .object({
...
export const UserUncheckedCreateWithoutBookmarkBandsInputObjectSchema = Schema;
