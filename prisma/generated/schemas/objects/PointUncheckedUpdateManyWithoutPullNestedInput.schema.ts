...
const Schema: z.ZodType<Prisma.PointUncheckedUpdateManyWithoutPullNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => PointUncheckedCreateWithoutPullInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => PointCreateOrConnectWithoutPullInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
...
export const PointUncheckedUpdateManyWithoutPullNestedInputObjectSchema =
  Schema;
