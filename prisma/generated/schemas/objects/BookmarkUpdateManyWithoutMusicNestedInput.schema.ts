...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithoutMusicNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => BookmarkUpdateManyWithWhereWithoutMusicInputObjectSchema),
        z
          .lazy(() => BookmarkUpdateManyWithWhereWithoutMusicInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const BookmarkUpdateManyWithoutMusicNestedInputObjectSchema = Schema;
