...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithoutIssueNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CommentUpsertWithWhereUniqueWithoutIssueInputObjectSchema),
        z
          .lazy(() => CommentUpsertWithWhereUniqueWithoutIssueInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => CommentUpdateWithWhereUniqueWithoutIssueInputObjectSchema),
        z
          .lazy(() => CommentUpdateWithWhereUniqueWithoutIssueInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CommentUpdateManyWithoutIssueNestedInputObjectSchema = Schema;
