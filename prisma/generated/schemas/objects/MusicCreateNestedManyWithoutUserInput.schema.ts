...
const Schema: z.ZodType<Prisma.MusicCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => MusicUncheckedCreateWithoutUserInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => MusicCreateOrConnectWithoutUserInputObjectSchema),
        z.lazy(() => MusicCreateOrConnectWithoutUserInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
...
export const MusicCreateNestedManyWithoutUserInputObjectSchema = Schema;
