...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutBookmarkMusicsInput> =
  z
    .object({
...
export const UserUpdateManyWithWhereWithoutBookmarkMusicsInputObjectSchema =
  Schema;
