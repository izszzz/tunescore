...
const Schema: z.ZodType<Prisma.NotificationCreateNestedManyWithoutFollowedInput> =
  z
    .object({
      create: z
        .union([
...
export const NotificationCreateNestedManyWithoutFollowedInputObjectSchema =
  Schema;
