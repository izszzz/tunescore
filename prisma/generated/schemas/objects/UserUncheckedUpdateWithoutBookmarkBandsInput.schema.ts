...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBookmarkBandsInput> = z
  .object({
    name: z
      .union([
        z.string(),
...
export const UserUncheckedUpdateWithoutBookmarkBandsInputObjectSchema = Schema;
