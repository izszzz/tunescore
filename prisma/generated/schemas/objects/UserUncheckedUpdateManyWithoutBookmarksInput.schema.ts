...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutBookmarksInput> = z
  .object({
    name: z
      .union([
        z.string(),
...
export const UserUncheckedUpdateManyWithoutBookmarksInputObjectSchema = Schema;
