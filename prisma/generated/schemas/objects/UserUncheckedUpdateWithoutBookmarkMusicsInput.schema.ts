...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBookmarkMusicsInput> =
  z
    .object({
      name: z
        .union([
...
export const UserUncheckedUpdateWithoutBookmarkMusicsInputObjectSchema = Schema;
