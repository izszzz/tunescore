...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutBookmarkArtistsInput> =
  z
    .object({
...
export const UserUpdateManyWithWhereWithoutBookmarkArtistsInputObjectSchema =
  Schema;
