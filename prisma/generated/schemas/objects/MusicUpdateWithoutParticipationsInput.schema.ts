...
import { PointUpdateManyWithoutMusicNestedInputObjectSchema } from './PointUpdateManyWithoutMusicNestedInput.schema';
...
const Schema: z.ZodType<Prisma.MusicUpdateWithoutParticipationsInput> = z
  .object({
    type: z
      .union([
    ...
    purchases: z
      ...
      .optional(),
    points: z
      .lazy(() => PointUpdateManyWithoutMusicNestedInputObjectSchema)
      .optional(),
    bookmarks: z
...
export const MusicUpdateWithoutParticipationsInputObjectSchema = Schema;
