...
const Schema: z.ZodType<Prisma.BandUpdateManyWithoutArtistsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => BandUpsertWithWhereUniqueWithoutArtistsInputObjectSchema),
        z
          .lazy(() => BandUpsertWithWhereUniqueWithoutArtistsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => BandUpdateWithWhereUniqueWithoutArtistsInputObjectSchema),
        z
          .lazy(() => BandUpdateWithWhereUniqueWithoutArtistsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
