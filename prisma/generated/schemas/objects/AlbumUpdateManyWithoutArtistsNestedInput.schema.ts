...
const Schema: z.ZodType<Prisma.AlbumUpdateManyWithoutArtistsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => AlbumUpsertWithWhereUniqueWithoutArtistsInputObjectSchema),
        z
          .lazy(() => AlbumUpsertWithWhereUniqueWithoutArtistsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => AlbumUpdateWithWhereUniqueWithoutArtistsInputObjectSchema),
        z
          .lazy(() => AlbumUpdateWithWhereUniqueWithoutArtistsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const AlbumUpdateManyWithoutArtistsNestedInputObjectSchema = Schema;
