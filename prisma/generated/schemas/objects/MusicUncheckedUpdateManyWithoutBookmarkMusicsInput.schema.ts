...
const Schema: z.ZodType<Prisma.MusicUncheckedUpdateManyWithoutBookmarkMusicsInput> =
  z
    .object({
      type: z
        .union([
...
export const MusicUncheckedUpdateManyWithoutBookmarkMusicsInputObjectSchema =
  Schema;
