...
function IndexLayout<T>({ header, meta, route, newRoute, children, searchAutocompleteProps }: IndexLayoutProps<T>) {
		...
		<SingleColumnLayout contained header={header}>
			<Grid container spacing={1}>
				...
				<Grid item xs={1} display="flex" alignItems="stretch">
					<Button variant="outlined" startIcon={<AddIcon />} onClick={handleClick} fullWidth>New</Button>
				</Grid>
			</Grid>
			{children}
