...
const Schema: z.ZodType<Prisma.MusicUncheckedUpdateManyWithoutArtistsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MusicUncheckedUpdateManyWithoutArtistsNestedInputObjectSchema =
  Schema;
