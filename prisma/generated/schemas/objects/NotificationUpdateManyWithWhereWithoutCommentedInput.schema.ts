...
const Schema: z.ZodType<Prisma.NotificationUpdateManyWithWhereWithoutCommentedInput> =
  z
    .object({
...
export const NotificationUpdateManyWithWhereWithoutCommentedInputObjectSchema =
  Schema;
