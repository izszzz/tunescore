...
const Schema: z.ZodType<Prisma.MusicUncheckedUpdateManyWithoutWrittenMusicsInput> =
  z
    .object({
      type: z
        .union([
...
export const MusicUncheckedUpdateManyWithoutWrittenMusicsInputObjectSchema =
  Schema;
