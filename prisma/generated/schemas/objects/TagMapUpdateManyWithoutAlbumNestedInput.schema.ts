...
const Schema: z.ZodType<Prisma.TagMapUpdateManyWithoutAlbumNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => TagMapUpsertWithWhereUniqueWithoutAlbumInputObjectSchema),
        z
          .lazy(() => TagMapUpsertWithWhereUniqueWithoutAlbumInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => TagMapUpdateWithWhereUniqueWithoutAlbumInputObjectSchema),
        z
          .lazy(() => TagMapUpdateWithWhereUniqueWithoutAlbumInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const TagMapUpdateManyWithoutAlbumNestedInputObjectSchema = Schema;
