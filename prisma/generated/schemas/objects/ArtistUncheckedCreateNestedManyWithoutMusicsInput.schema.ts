...
const Schema: z.ZodType<Prisma.ArtistUncheckedCreateNestedManyWithoutMusicsInput> =
  z.union([
    z
      .object({
        create: z
...
export const ArtistUncheckedCreateNestedManyWithoutMusicsInputObjectSchema =
  Schema;
