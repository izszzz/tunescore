...
const Schema: z.ZodType<Prisma.ArtistUncheckedCreateNestedManyWithoutBandsInput> =
  z.union([
    z
      .object({
        create: z
...
export const ArtistUncheckedCreateNestedManyWithoutBandsInputObjectSchema =
  Schema;
