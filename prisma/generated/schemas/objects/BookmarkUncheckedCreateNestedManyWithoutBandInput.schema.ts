...
const Schema: z.ZodType<Prisma.BookmarkUncheckedCreateNestedManyWithoutBandInput> =
  z
    .object({
      create: z
        .union([
...
export const BookmarkUncheckedCreateNestedManyWithoutBandInputObjectSchema =
  Schema;
