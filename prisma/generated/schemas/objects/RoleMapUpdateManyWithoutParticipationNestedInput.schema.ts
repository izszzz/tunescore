...
const Schema: z.ZodType<Prisma.RoleMapUpdateManyWithoutParticipationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RoleMapUpdateManyWithoutParticipationNestedInputObjectSchema =
  Schema;
