...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutBookmarksNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutBookmarksInputObjectSchema)
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutBookmarksInputObjectSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutBookmarksNestedInputObjectSchema =
  Schema;
