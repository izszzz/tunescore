...
const Schema: z.ZodType<Prisma.VoteUncheckedCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => VoteUncheckedCreateWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => VoteCreateOrConnectWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      connect: z
...
export const VoteUncheckedCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
