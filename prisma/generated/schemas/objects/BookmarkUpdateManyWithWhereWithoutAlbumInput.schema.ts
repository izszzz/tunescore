...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithWhereWithoutAlbumInput> = z
  .object({
...
export const BookmarkUpdateManyWithWhereWithoutAlbumInputObjectSchema = Schema;
