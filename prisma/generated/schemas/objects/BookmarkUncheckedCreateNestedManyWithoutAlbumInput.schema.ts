...
const Schema: z.ZodType<Prisma.BookmarkUncheckedCreateNestedManyWithoutAlbumInput> =
  z
    .object({
      create: z
        .union([
...
export const BookmarkUncheckedCreateNestedManyWithoutAlbumInputObjectSchema =
  Schema;
