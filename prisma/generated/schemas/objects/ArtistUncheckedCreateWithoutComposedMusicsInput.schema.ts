...
const Schema: z.ZodType<Prisma.ArtistUncheckedCreateWithoutComposedMusicsInput> =
  z
    .object({
      ...
      writtenMusics: z
        .lazy(
          () => MusicUncheckedCreateNestedManyWithoutLyristsInputObjectSchema,
        )
        .optional(),
      writtenMusicsIDs: z
        .union([
...
export const ArtistUncheckedCreateWithoutComposedMusicsInputObjectSchema =
  Schema;
