...
const Schema: z.ZodType<Prisma.MusicUncheckedUpdateManyWithoutComposersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MusicUncheckedUpdateManyWithoutComposersNestedInputObjectSchema =
  Schema;
