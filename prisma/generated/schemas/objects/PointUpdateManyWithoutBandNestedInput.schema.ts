...
const Schema: z.ZodType<Prisma.PointUpdateManyWithoutBandNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => PointUncheckedCreateWithoutBandInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => PointCreateOrConnectWithoutBandInputObjectSchema),
        z.lazy(() => PointCreateOrConnectWithoutBandInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const PointUpdateManyWithoutBandNestedInputObjectSchema = Schema;
