...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutBookmarkAlbumsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedUpdateManyWithoutBookmarkAlbumsNestedInputObjectSchema =
  Schema;
