...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithWhereWithoutArtistInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => BookmarkUncheckedUpdateManyWithoutBookmarksInputObjectSchema,
        ),
      ]),
    })
    .strict();

export const BookmarkUpdateManyWithWhereWithoutArtistInputObjectSchema = Schema;
