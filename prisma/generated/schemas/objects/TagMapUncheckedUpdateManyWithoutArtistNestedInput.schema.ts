...
const Schema: z.ZodType<Prisma.TagMapUncheckedUpdateManyWithoutArtistNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => TagMapUpsertWithWhereUniqueWithoutArtistInputObjectSchema,
          ),
          z
            .lazy(
              () => TagMapUpsertWithWhereUniqueWithoutArtistInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => TagMapUpdateWithWhereUniqueWithoutArtistInputObjectSchema,
          ),
          z
            .lazy(
              () => TagMapUpdateWithWhereUniqueWithoutArtistInputObjectSchema,
...
export const TagMapUncheckedUpdateManyWithoutArtistNestedInputObjectSchema =
  Schema;
