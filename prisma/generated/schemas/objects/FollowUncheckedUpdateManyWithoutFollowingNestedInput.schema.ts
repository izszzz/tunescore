...
const Schema: z.ZodType<Prisma.FollowUncheckedUpdateManyWithoutFollowingNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FollowUncheckedUpdateManyWithoutFollowingNestedInputObjectSchema =
  Schema;
