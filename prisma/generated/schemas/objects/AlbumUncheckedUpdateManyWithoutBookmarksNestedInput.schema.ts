...
const Schema: z.ZodType<Prisma.AlbumUncheckedUpdateManyWithoutBookmarksNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => AlbumUpdateManyWithWhereWithoutBookmarksInputObjectSchema,
          ),
          z
            .lazy(
              () => AlbumUpdateManyWithWhereWithoutBookmarksInputObjectSchema,
...
export const AlbumUncheckedUpdateManyWithoutBookmarksNestedInputObjectSchema =
  Schema;
