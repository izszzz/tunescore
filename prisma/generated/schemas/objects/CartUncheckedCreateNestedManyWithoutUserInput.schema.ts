...
const Schema: z.ZodType<Prisma.CartUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const CartUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
