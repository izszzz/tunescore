...
const Schema: z.ZodType<Prisma.PurchaseUpdateManyWithoutMusicNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => PurchaseUpdateManyWithWhereWithoutMusicInputObjectSchema),
        z
          .lazy(() => PurchaseUpdateManyWithWhereWithoutMusicInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const PurchaseUpdateManyWithoutMusicNestedInputObjectSchema = Schema;
