...
const Schema: z.ZodType<Prisma.NotificationUncheckedUpdateManyWithoutCommentedNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const NotificationUncheckedUpdateManyWithoutCommentedNestedInputObjectSchema =
  Schema;
