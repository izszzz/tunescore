...
const Schema: z.ZodType<Prisma.ArtistUncheckedUpdateManyWithoutLyristsInput> = z
  .object({
    name: z
      .union([
...
export const ArtistUncheckedUpdateManyWithoutLyristsInputObjectSchema = Schema;
