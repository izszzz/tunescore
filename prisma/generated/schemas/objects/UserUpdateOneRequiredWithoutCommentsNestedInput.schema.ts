...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutCommentsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutCommentsInputObjectSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutCommentsNestedInputObjectSchema =
  Schema;
