...
const Schema: z.ZodType<Prisma.BandUpdateManyWithoutBookmarksNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => BandUpdateManyWithWhereWithoutBookmarksInputObjectSchema),
        z
          .lazy(() => BandUpdateManyWithWhereWithoutBookmarksInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
