...
const Schema: z.ZodType<Prisma.TagMapUncheckedCreateNestedManyWithoutArtistInput> =
  z
    .object({
      create: z
        .union([
...
export const TagMapUncheckedCreateNestedManyWithoutArtistInputObjectSchema =
  Schema;
