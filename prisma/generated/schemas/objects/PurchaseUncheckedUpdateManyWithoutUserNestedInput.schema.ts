...
const Schema: z.ZodType<Prisma.PurchaseUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => PurchaseUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => PurchaseUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => PurchaseUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => PurchaseUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const PurchaseUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
