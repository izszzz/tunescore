...
const Schema: z.ZodType<Prisma.NotificationUncheckedUpdateWithoutBookmarkedInput> =
  z
    .object({
      userId: z
        .union([
...
export const NotificationUncheckedUpdateWithoutBookmarkedInputObjectSchema =
  Schema;
