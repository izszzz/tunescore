...
const Schema: z.ZodType<Prisma.NotificationUncheckedCreateNestedManyWithoutCommentedInput> =
  z
    .object({
      create: z
        .union([
...
export const NotificationUncheckedCreateNestedManyWithoutCommentedInputObjectSchema =
  Schema;
