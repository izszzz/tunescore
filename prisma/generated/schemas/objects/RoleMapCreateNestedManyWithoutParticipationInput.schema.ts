...
const Schema: z.ZodType<Prisma.RoleMapCreateNestedManyWithoutParticipationInput> =
  z
    .object({
      create: z
        .union([
...
export const RoleMapCreateNestedManyWithoutParticipationInputObjectSchema =
  Schema;
