...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithWhereWithoutBandInput> = z
  .object({
...
export const BookmarkUpdateManyWithWhereWithoutBandInputObjectSchema = Schema;
