...
const Schema: z.ZodType<Prisma.NotificationUpdateManyWithWhereWithoutFollowedInput> =
  z
    .object({
...
export const NotificationUpdateManyWithWhereWithoutFollowedInputObjectSchema =
  Schema;
