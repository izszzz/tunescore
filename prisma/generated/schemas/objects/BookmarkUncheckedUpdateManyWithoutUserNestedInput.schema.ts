...
const Schema: z.ZodType<Prisma.BookmarkUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => BookmarkUncheckedCreateWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => BookmarkCreateOrConnectWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => BookmarkUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => BookmarkUpsertWithWhereUniqueWithoutUserInputObjectSchema,
        ...
        .optional(),
      createMany: z
        .lazy(() => BookmarkCreateManyUserInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => BookmarkUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => BookmarkUpdateWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      updateMany: z
        .union([
          ...
          z
            .lazy(() => BookmarkUpdateManyWithWhereWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const BookmarkUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
