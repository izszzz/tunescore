...
const Schema: z.ZodType<Prisma.IssueCreateNestedManyWithoutMusicInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => IssueUncheckedCreateWithoutMusicInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => IssueCreateOrConnectWithoutMusicInputObjectSchema),
        z.lazy(() => IssueCreateOrConnectWithoutMusicInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
