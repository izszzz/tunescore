...
const Schema: z.ZodType<Prisma.NotificationUpdateManyWithoutFollowedNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const NotificationUpdateManyWithoutFollowedNestedInputObjectSchema =
  Schema;
