...
const Schema: z.ZodType<Prisma.TagMapUpdateManyWithWhereWithoutArtistInput> = z
  .object({
...
export const TagMapUpdateManyWithWhereWithoutArtistInputObjectSchema = Schema;
