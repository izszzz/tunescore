...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithWhereWithoutMusicInput> = z
  .object({
...
export const BookmarkUpdateManyWithWhereWithoutMusicInputObjectSchema = Schema;
