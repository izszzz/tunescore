...
const Schema: z.ZodType<Prisma.NotificationUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const NotificationUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
