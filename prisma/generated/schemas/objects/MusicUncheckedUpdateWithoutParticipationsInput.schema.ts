...
const Schema: z.ZodType<Prisma.MusicUncheckedUpdateWithoutParticipationsInput> =
  z
    .object({
      type: z
        .union([
      ...
      albums: z
        .lazy(
          () => AlbumUncheckedUpdateManyWithoutMusicsNestedInputObjectSchema,
        )
        .optional(),
      albumIDs: z
        .union([
      ...
      tagMaps: z
        .lazy(
          () => TagMapUncheckedUpdateManyWithoutMusicNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const MusicUncheckedUpdateWithoutParticipationsInputObjectSchema =
  Schema;
