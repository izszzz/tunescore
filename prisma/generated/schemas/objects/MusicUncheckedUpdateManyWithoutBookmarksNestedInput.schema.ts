...
const Schema: z.ZodType<Prisma.MusicUncheckedUpdateManyWithoutBookmarksNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const MusicUncheckedUpdateManyWithoutBookmarksNestedInputObjectSchema =
  Schema;
