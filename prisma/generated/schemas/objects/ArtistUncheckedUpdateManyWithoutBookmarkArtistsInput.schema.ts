...
const Schema: z.ZodType<Prisma.ArtistUncheckedUpdateManyWithoutBookmarkArtistsInput> =
  z
    .object({
      name: z
        .union([
...
export const ArtistUncheckedUpdateManyWithoutBookmarkArtistsInputObjectSchema =
  Schema;
