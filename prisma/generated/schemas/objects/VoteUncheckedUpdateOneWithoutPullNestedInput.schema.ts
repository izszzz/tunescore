...
const Schema: z.ZodType<Prisma.VoteUncheckedUpdateOneWithoutPullNestedInput> = z
  .object({
    create: z
      .union([
...
export const VoteUncheckedUpdateOneWithoutPullNestedInputObjectSchema = Schema;
