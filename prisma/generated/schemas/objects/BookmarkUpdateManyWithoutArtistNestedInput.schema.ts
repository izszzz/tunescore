...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithoutArtistNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => BookmarkUpdateManyWithWhereWithoutArtistInputObjectSchema),
        z
          .lazy(() => BookmarkUpdateManyWithWhereWithoutArtistInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const BookmarkUpdateManyWithoutArtistNestedInputObjectSchema = Schema;
