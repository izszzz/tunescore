...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithWhereWithoutIssueInput> = z
  .object({
...
export const CommentUpdateManyWithWhereWithoutIssueInputObjectSchema = Schema;
