...
const Schema: z.ZodType<Prisma.TagMapUpdateManyWithoutMusicNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => TagMapUpsertWithWhereUniqueWithoutMusicInputObjectSchema),
        z
          .lazy(() => TagMapUpsertWithWhereUniqueWithoutMusicInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => TagMapUpdateWithWhereUniqueWithoutMusicInputObjectSchema),
        z
          .lazy(() => TagMapUpdateWithWhereUniqueWithoutMusicInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const TagMapUpdateManyWithoutMusicNestedInputObjectSchema = Schema;
