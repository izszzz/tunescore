...
const Schema: z.ZodType<Prisma.TagMapUncheckedCreateNestedManyWithoutAlbumInput> =
  z
    .object({
      create: z
        .union([
...
export const TagMapUncheckedCreateNestedManyWithoutAlbumInputObjectSchema =
  Schema;
