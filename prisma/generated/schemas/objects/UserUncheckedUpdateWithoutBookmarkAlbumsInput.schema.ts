...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBookmarkAlbumsInput> =
  z
    .object({
      name: z
        .union([
...
export const UserUncheckedUpdateWithoutBookmarkAlbumsInputObjectSchema = Schema;
