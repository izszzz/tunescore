...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutBookmarkBandsInput> =
  z.union([
    z
      .object({
        create: z
...
export const UserCreateNestedManyWithoutBookmarkBandsInputObjectSchema = Schema;
