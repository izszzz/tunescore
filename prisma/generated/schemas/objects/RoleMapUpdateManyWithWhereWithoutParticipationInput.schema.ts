...
const Schema: z.ZodType<Prisma.RoleMapUpdateManyWithWhereWithoutParticipationInput> =
  z
    .object({
...
export const RoleMapUpdateManyWithWhereWithoutParticipationInputObjectSchema =
  Schema;
