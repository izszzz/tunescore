...
const Schema: z.ZodType<Prisma.TagMapUncheckedUpdateManyWithoutTagMapsInput> = z
  .object({
    tagId: z
      .union([
        z.string(),
...
export const TagMapUncheckedUpdateManyWithoutTagMapsInputObjectSchema = Schema;
