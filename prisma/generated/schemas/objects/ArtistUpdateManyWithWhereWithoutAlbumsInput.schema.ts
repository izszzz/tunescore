...
const Schema: z.ZodType<Prisma.ArtistUpdateManyWithWhereWithoutAlbumsInput> = z
  .object({
...
export const ArtistUpdateManyWithWhereWithoutAlbumsInputObjectSchema = Schema;
