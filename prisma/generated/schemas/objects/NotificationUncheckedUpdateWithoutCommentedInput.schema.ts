...
const Schema: z.ZodType<Prisma.NotificationUncheckedUpdateWithoutCommentedInput> =
  z
    .object({
      userId: z
        .union([
...
export const NotificationUncheckedUpdateWithoutCommentedInputObjectSchema =
  Schema;
