...
const Schema: z.ZodType<Prisma.PointUncheckedUpdateManyWithoutMusicNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => PointUncheckedCreateWithoutMusicInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => PointCreateOrConnectWithoutMusicInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
...
export const PointUncheckedUpdateManyWithoutMusicNestedInputObjectSchema =
  Schema;
