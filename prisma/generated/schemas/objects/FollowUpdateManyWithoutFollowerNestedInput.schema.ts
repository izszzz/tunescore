...
const Schema: z.ZodType<Prisma.FollowUpdateManyWithoutFollowerNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => FollowUpdateManyWithWhereWithoutFollowerInputObjectSchema),
        z
          .lazy(() => FollowUpdateManyWithWhereWithoutFollowerInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const FollowUpdateManyWithoutFollowerNestedInputObjectSchema = Schema;
