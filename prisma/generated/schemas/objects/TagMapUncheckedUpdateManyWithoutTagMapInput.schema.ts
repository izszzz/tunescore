...
const Schema: z.ZodType<Prisma.TagMapUncheckedUpdateManyWithoutTagMapInput> = z
  .object({
    resourceId: z
      .union([
        z.string(),
...
export const TagMapUncheckedUpdateManyWithoutTagMapInputObjectSchema = Schema;
