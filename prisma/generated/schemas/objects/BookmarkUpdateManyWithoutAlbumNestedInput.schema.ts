...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithoutAlbumNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => BookmarkUpdateManyWithWhereWithoutAlbumInputObjectSchema),
        z
          .lazy(() => BookmarkUpdateManyWithWhereWithoutAlbumInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const BookmarkUpdateManyWithoutAlbumNestedInputObjectSchema = Schema;
