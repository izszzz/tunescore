...
const Schema: z.ZodType<Prisma.MusicUncheckedCreateWithoutParticipationsInput> =
  z
    .object({
      ...
      albums: z
        .lazy(
          () => AlbumUncheckedCreateNestedManyWithoutMusicsInputObjectSchema,
        )
        .optional(),
      albumIDs: z
        .union([
      ...
      tagMaps: z
        .lazy(
          () => TagMapUncheckedCreateNestedManyWithoutMusicInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const MusicUncheckedCreateWithoutParticipationsInputObjectSchema =
  Schema;
