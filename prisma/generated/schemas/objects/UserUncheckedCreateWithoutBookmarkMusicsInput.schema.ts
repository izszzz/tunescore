...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBookmarkMusicsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutBookmarkMusicsInputObjectSchema = Schema;
