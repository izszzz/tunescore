...
import { PurchaseUpdateManyWithoutUserNestedInputObjectSchema } from './PurchaseUpdateManyWithoutUserNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutMusicsInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    carts: z
      ...
      .optional(),
    purchases: z
      .lazy(() => PurchaseUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    points: z
...
export const UserUpdateWithoutMusicsInputObjectSchema = Schema;
