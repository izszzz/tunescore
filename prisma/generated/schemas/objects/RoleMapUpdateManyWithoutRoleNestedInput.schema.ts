...
const Schema: z.ZodType<Prisma.RoleMapUpdateManyWithoutRoleNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => RoleMapUpsertWithWhereUniqueWithoutRoleInputObjectSchema),
        z
          .lazy(() => RoleMapUpsertWithWhereUniqueWithoutRoleInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => RoleMapUpdateWithWhereUniqueWithoutRoleInputObjectSchema),
        z
          .lazy(() => RoleMapUpdateWithWhereUniqueWithoutRoleInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const RoleMapUpdateManyWithoutRoleNestedInputObjectSchema = Schema;
