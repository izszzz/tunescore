...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutBookmarkAlbumsInput> =
  z
    .object({
...
export const UserUpdateManyWithWhereWithoutBookmarkAlbumsInputObjectSchema =
  Schema;
