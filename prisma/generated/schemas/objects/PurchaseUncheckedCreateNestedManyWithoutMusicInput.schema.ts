...
const Schema: z.ZodType<Prisma.PurchaseUncheckedCreateNestedManyWithoutMusicInput> =
  z
    .object({
      create: z
        .union([
...
export const PurchaseUncheckedCreateNestedManyWithoutMusicInputObjectSchema =
  Schema;
