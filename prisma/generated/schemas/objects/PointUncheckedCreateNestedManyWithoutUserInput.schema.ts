...
const Schema: z.ZodType<Prisma.PointUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => PointUncheckedCreateWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => PointCreateOrConnectWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
...
export const PointUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
