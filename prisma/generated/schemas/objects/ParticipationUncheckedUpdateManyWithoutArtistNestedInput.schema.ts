...
const Schema: z.ZodType<Prisma.ParticipationUncheckedUpdateManyWithoutArtistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ParticipationUncheckedUpdateManyWithoutArtistNestedInputObjectSchema =
  Schema;
