...
const Schema: z.ZodType<Prisma.AlbumUpdateManyWithoutMusicsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => AlbumUpsertWithWhereUniqueWithoutMusicsInputObjectSchema),
        z
          .lazy(() => AlbumUpsertWithWhereUniqueWithoutMusicsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => AlbumUpdateWithWhereUniqueWithoutMusicsInputObjectSchema),
        z
          .lazy(() => AlbumUpdateWithWhereUniqueWithoutMusicsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const AlbumUpdateManyWithoutMusicsNestedInputObjectSchema = Schema;
