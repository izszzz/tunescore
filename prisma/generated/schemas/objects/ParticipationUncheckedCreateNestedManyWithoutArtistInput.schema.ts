...
const Schema: z.ZodType<Prisma.ParticipationUncheckedCreateNestedManyWithoutArtistInput> =
  z
    .object({
      create: z
        .union([
...
export const ParticipationUncheckedCreateNestedManyWithoutArtistInputObjectSchema =
  Schema;
