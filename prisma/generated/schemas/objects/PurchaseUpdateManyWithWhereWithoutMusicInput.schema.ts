...
const Schema: z.ZodType<Prisma.PurchaseUpdateManyWithWhereWithoutMusicInput> = z
  .object({
...
export const PurchaseUpdateManyWithWhereWithoutMusicInputObjectSchema = Schema;
