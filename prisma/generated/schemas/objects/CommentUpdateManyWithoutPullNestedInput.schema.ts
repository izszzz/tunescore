...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithoutPullNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CommentUpsertWithWhereUniqueWithoutPullInputObjectSchema),
        z
          .lazy(() => CommentUpsertWithWhereUniqueWithoutPullInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => CommentUpdateWithWhereUniqueWithoutPullInputObjectSchema),
        z
          .lazy(() => CommentUpdateWithWhereUniqueWithoutPullInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CommentUpdateManyWithoutPullNestedInputObjectSchema = Schema;
