...
const Schema: z.ZodType<Prisma.TagMapUpdateManyWithoutBandNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => TagMapUncheckedCreateWithoutBandInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => TagMapCreateOrConnectWithoutBandInputObjectSchema),
        z.lazy(() => TagMapCreateOrConnectWithoutBandInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const TagMapUpdateManyWithoutBandNestedInputObjectSchema = Schema;
