...
const Schema: z.ZodType<Prisma.NotificationUncheckedUpdateManyWithoutBookmarkedNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const NotificationUncheckedUpdateManyWithoutBookmarkedNestedInputObjectSchema =
  Schema;
