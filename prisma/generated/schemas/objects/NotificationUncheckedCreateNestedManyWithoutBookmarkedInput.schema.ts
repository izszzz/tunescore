...
const Schema: z.ZodType<Prisma.NotificationUncheckedCreateNestedManyWithoutBookmarkedInput> =
  z
    .object({
      create: z
        .union([
...
export const NotificationUncheckedCreateNestedManyWithoutBookmarkedInputObjectSchema =
  Schema;
