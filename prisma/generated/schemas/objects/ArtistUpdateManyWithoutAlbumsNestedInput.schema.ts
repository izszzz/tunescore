...
const Schema: z.ZodType<Prisma.ArtistUpdateManyWithoutAlbumsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ArtistUpsertWithWhereUniqueWithoutAlbumsInputObjectSchema),
        z
          .lazy(() => ArtistUpsertWithWhereUniqueWithoutAlbumsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => ArtistUpdateWithWhereUniqueWithoutAlbumsInputObjectSchema),
        z
          .lazy(() => ArtistUpdateWithWhereUniqueWithoutAlbumsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
